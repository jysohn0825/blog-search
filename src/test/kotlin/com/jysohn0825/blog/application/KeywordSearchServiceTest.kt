...
class KeywordSearchServiceTest {
    ...
    private fun getResponse(
        ...
        val meta = KakaoSearchByKeywordResponse.Meta(list.size * 2, list.size, isEnd)
        val documents = list.let { response ->
            ...
            if(isEnd) it.slice(meta.pageableCount / size + 1 until meta.pageableCount / size + list.size )
